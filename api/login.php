...
<head>
    ...
    <title>Login - Konsultasi Dokter Online</title>
    <style>
        /* reset & font */
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', Roboto, sans-serif; }
        ...
        /* kontainer utama */
        .login-container { display: flex; max-width: 900px; width: 100%; background: white; border-radius: 20px; overflow: hidden; box-shadow: 0 15px 35px rgba(16, 95, 104, 0.15); }
        ...
        input[type="text"], input[type="password"] { width: 100%; padding: 14px; border: 1.5px solid #9ed5d1; border-radius: 10px; outline: none; transition: 0.3s; font-size: 0.95rem; color: #105f68; }
        input:focus { border-color: #63c1bb; box-shadow: 0 0 0 4px rgba(99, 193, 187, 0.1); }
        
        /* fitur tambahan */
        .extra-actions { display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px; font-size: 0.85rem; color: #3a9295; }
        .remember { display: flex; align-items: center; gap: 8px; cursor: pointer; }
        
        /* tombol login */
        button { width: 100%; padding: 14px; border: none; border-radius: 10px; background: #63c1bb; color: white; font-weight: 700; cursor: pointer; font-size: 1rem; transition: 0.3s; box-shadow: 0 4px 12px rgba(99, 193, 187, 0.3); }
...
<body>
    ...
    <div class="login-container">
        <div class="side-info">
            ...
            <h1>Solusi Kesehatan Terpercaya</h1>
            <p>Akses konsultasi dengan dokter profesional kapan saja dan di mana saja. Kesehatan Anda adalah prioritas utama kami.</p>
        </div>
        ...
        <div class="side-form">
            ...
            <form action="prosesLogin.php" method="POST">
                ...
                <div class="extra-actions">
                    ...
                    <a href="#" style="color: #3a9295; text-decoration: none;">Lupa Password?</a>
                </div>
